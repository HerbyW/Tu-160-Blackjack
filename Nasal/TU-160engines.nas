# from CitationX: modified for 4 engines TU-160 by Herbert Wagner 01/2016
...
#################################################################################
setprop("controls/engines/afterburnerconst", 0);

setlistener("controls/engines/engine/throttle", func
 { 
 if (getprop("controls/engines/engine/throttle") > 0.88  )
  {
    setprop("controls/engines/afterburnerconst", 1);    
  }
  else 
  {
    setprop("controls/engines/afterburnerconst", 0);
